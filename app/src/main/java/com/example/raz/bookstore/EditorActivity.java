...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void saveBook() {
        ...
        if (mCurrentBookUri == null) {
            ...
            // Show a toast message depending on whether or not the insertion was s
            // unsuccessful.
            if (newUri == null) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            String supplierPhoneString = cursor.getString(supplierPhoneColumnIndex);

            // Update the views on the screen with the values from the database
            mBookNameEditText.setText(nameString);
            mPriceEditText.setText(Integer.toString(price));
            mQuantityEditText.setText(Integer.toString(quantity));
            mSupplierNameEditText.setText(supplierString);
            mSupplierPhoneNumberEditText.setText(supplierPhoneString);
        }
    }
