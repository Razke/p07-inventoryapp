...
public class EditorActivity extends AppCompatActivity implements
    ...
    public static String supplierPhoneNumberString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentBookUri == null) {
            ...
            // This is a new book, so change the app bar to say "Add a book to inventory"
            ...
            // Otherwise this is an existing book, so change app bar to say "Edit book details"
    ...
    private void saveBook() {
        ...
        values.put(BookContract.BookEntry.COLUMN_BOOK_SUPPLIER, supplierNameString);
        values.put(BookContract.BookEntry.COLUMN_BOOK_SUPPLIER_PHONE, supplierPhoneNumberString);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                nameString = mBookNameEditText.getText().toString().trim();
                ...
                supplierPhoneNumberString = mSupplierPhoneNumberEditText.getText().toString().trim();
        ...
        public void onLoadFinished (Loader < Cursor > loader, Cursor cursor){
            ...
            if (cursor.moveToFirst()) {
                ...
                String supplierNameString = cursor.getString(supplierColumnIndex);
                String supplierPhoneNumberString = cursor.getString(supplierPhoneColumnIndex);

                // Update the views on the screen with the values from the database
                mBookNameEditText.setText(nameString);
