...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            // _id - nameString - price - quantity - supplierString - supplierPhoneString
            //
            ...
            while (cursor.moveToNext()) {
                ...
                String currenSupplier = cursor.getString(supplierColumnIndex);
    ...
    private void insertBook() {
        ...
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE, "00 1 206-266-2992");
        // Insert a new row for Head First Java in the database, returning the ID of that new row.
        // The first argument for db.insert() is the books table name.
        // The second argument provides the name of a column in which the framework
        // can insert NULL in the event that the ContentValues is empty (if
        // this is set to "null", then the framework will not insert a row when
        // there are no values).
        // The third argument is the ContentValues object containing the info for Head First Java.
